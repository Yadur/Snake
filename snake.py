#!/bin/python
import sys,os,pygame,random,math,string
from pygame_functions import *

pygame.init()
pygame.display.set_caption("Nsnake v1.2")
pygame.font.init()
random.seed()
...
PATH = "/home/noyonrud/Python/scoreboard.txt"
USEREVENT = 0
...
scoreboard_font = pygame.font.Font(None,19)
gameplayer_font = pygame.font.Font(None,19)
...
def drawGameplayer():
    wordbox = MakeTextBox(10, 80, 300, 0, "",0, 24)
    showTextBox(wordbox)
...
def drawScoreboard():
    scoreboard = open(PATH, 'r')
    for lines in scoreboard:
        lines_scoreboard = scoreboard_font.render(list(lines),1,pygame.Color("white"))
        screen.blit(lines_scoreboard,(160,120))
